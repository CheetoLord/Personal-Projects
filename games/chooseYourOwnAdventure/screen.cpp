...
string textBox::getVertAlignment() {
    return myVertAlignment;
}
...
void textBox::setAlignment(string alignment) {
    if(alignment == "left" || alignment == "right" || alignment == "center") {
        myAlignment = alignment;
    } else {
        cout << "Caution! alignment given is not recognised (" << alignment << ")\n";
    }
}

void textBox::setVertAlignment(string vertAlignment) {
    if(vertAlignment == "top" || vertAlignment == "bottom" || vertAlignment == "center") {
        myVertAlignment = vertAlignment;
    } else {
        cout << "Caution! alignment given is not recognised (" << vertAlignment << ")\n";
    }
}
...
void textBox::draw() {
    ...
    int currYPos = myY;
    if(myVertAlignment == "center") {
        currYPos -= globalScreen.getTextHeight(text)/2;
    } else if(myVertAlignment == "bottom") {
        currYPos -= globalScreen.getTextHeight(text);
    }
    ...
    while(text.length() > 0) {
        ...
        globalScreen.drawText(currLine, xPos, currYPos);
        currYPos += globalScreen.getNewlineYDiff();
    }
}
