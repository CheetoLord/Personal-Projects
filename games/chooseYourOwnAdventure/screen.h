...
public:
    ...
    bool getUpArrowState() {return upArrowPressed;}
    bool getDownArrowState() {return downArrowPressed;}
    bool getLeftArrowState() {return leftArrowPressed;}
    bool getRightArrowState() {return rightArrowPressed;}
...
public:
    ...
    void setVertAlignment(string vertAlignment);
...
public:
    ...
    int find2PrevNewline();
    int findPrevNewline();
    int findNextNewline();
    int findNext2Newline();
    int findPosInLine();
    void moveCursorUp();
    void moveCursorDown();
    void moveCursorLeft();
    ...
    void multiLine(bool multiLined);
