...
public:
    ...
    void updateBitmap(bool **newBitmap);
...
public:
    ...
    void setSpacewidth(int newSpaceWidth) {spacewidth = newSpaceWidth;};
    void setCharSpacing(int newCharSpacing) {charspacing = newCharSpacing;};
    void setFontName(string newFontName) {fontName = newFontName;};
    character *getCharacterClass(char c);

    void saveFontChangesToFile();
    void reloadFromFile();
